...
type WithEpisodeDataProps = {
  bookId: string;
  episode: GetBookResponseWithEpisode['episodes'][number];
};

export const EpisodeListItemWithEpisodeData: React.FC<WithEpisodeDataProps> = ({ bookId, episode }) => {
